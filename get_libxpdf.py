...
def cmake_run_install(configure_cmd, cmake_build_dir, install_prefix,
    ...
    call_subprocess(
        ...
        cwd=cmake_build_dir, **call_setup)
    call_subprocess(
...
def build_libxpdf(download_dir, extract_dir,
    ...
    libxpdf_dir  = unpack_tarball(download_libxpdf_source(download_dir, libxpdf_version),
    ...
    # build libxpdf
    cmake_run_install(configure_cmd, cmake_build_dir, prefix, build_type, multicore, **call_setup)
